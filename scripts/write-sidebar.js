...
const content = [
  ...
  "    { name: 'Analytics', path: '/admin/analytics', icon: Star },",
  "  ];",
  "",
  "  const links = role === 'ADMIN' || role === 'SUPER_ADMIN' ? adminLinks : role === 'VENDOR_OWNER' || role === 'PROFESSIONAL' ? vendorLinks : customerLinks;",
  "",
...
fs.writeFileSync('c:/Nexserve/frontend/src/components/layout/Sidebar.tsx', content, 'utf8');
console.log('Sidebar.tsx written successfully with length:', content.length);
